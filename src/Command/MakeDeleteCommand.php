...
{
    protected static $defaultName = 'kodmit:make:delete';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $generatedFiles = $generator->generatedSpecificScope(AbstractGenerator::DELETE);
        ...
        $io->success('Messenger delete logic and controller generated, now add your own logic :)');
